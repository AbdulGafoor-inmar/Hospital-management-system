...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat ="server" style="background-color: #00FFFF; background-image: url('../Hospital.pink.jpg')">
        ...
        <br /><br />
           ...
           <div style="margin-left: 100px">
            ...
            <h4><strong>Total Number of Regstered Doctors: </strong>
            <asp:Label ID="TotalPatients" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label></h4>
            <br /><br />
               
            <h4><strong>Total Registered Patients: </strong>
            <asp:Label ID="Total_Doctors" runat="server"  Font-Bold="true" Font-Size="Medium"></asp:Label></h4>
            <br /><br />

            <h4><strong>Total Income: </strong>
            <asp:Label ID="TotalIncome" runat="server"  Font-Bold="true" Font-Size="Medium"></asp:Label></h4>
            <br /><br />
